...
LOG_SEVERITY_LEVELS_POSSIBLE_VALUES += \"$(LOG_SEVERITY_LEVEL_EMERGENCY)\" \"$(LOG_SEVERITY_LEVEL_EMERG)\" \"$(LOG_SEVERITY_LEVEL_0)\"
...
LOG_SEVERITY_LEVELS_POSSIBLE_VALUES += \"$(LOG_SEVERITY_LEVEL_ALERT)\" \"$(LOG_SEVERITY_LEVEL_1)\"
...
LOG_SEVERITY_LEVELS_POSSIBLE_VALUES += \"$(LOG_SEVERITY_LEVEL_CRITICAL)\" \"$(LOG_SEVERITY_LEVEL_CRIT)\" \"$(LOG_SEVERITY_LEVEL_2)\"
...
LOG_SEVERITY_LEVELS_POSSIBLE_VALUES += \"$(LOG_SEVERITY_LEVEL_ERROR)\" \"$(LOG_SEVERITY_LEVEL_ERR)\" \"$(LOG_SEVERITY_LEVEL_3)\"
...
LOG_SEVERITY_LEVELS_POSSIBLE_VALUES += \"$(LOG_SEVERITY_LEVEL_WARNING)\" \"$(LOG_SEVERITY_LEVEL_WARN)\" \"$(LOG_SEVERITY_LEVEL_4)\"
...
LOG_SEVERITY_LEVELS_POSSIBLE_VALUES += \"$(LOG_SEVERITY_LEVEL_NOTICE)\" \"$(LOG_SEVERITY_LEVEL_5)\"
...
LOG_SEVERITY_LEVELS_POSSIBLE_VALUES += \"$(LOG_SEVERITY_LEVEL_DEBUG)\" \"$(LOG_SEVERITY_LEVEL_7)\"
...
ifneq ($(strip $(LOG_SEVERITY_LEVEL)),$(LOG_SEVERITY_LEVEL_NONE))
